...
// Store in mind that instead of 'user-files', the name of each collection will be by its owner
...
router.post('/', upload.single('file'), async (req, res) => {
    try {
        ...
        // Clear the temp/uploads directory
        await fse.emptyDir('temp/uploads');
